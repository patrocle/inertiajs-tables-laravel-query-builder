import { ref as S, onMounted as Q, onBeforeUnmount as me, openBlock as a, createElementBlock as h, renderSlot as w, watch as U, createBlock as x, withCtx as C, createElementVNode as s, normalizeClass as $, withModifiers as B, withDirectives as D, vShow as R, resolveDynamicComponent as I, toDisplayString as p, createCommentVNode as k, computed as _, Fragment as P, renderList as O, unref as t, createVNode as z, createTextVNode as M, nextTick as be, getCurrentInstance as ye, onUnmounted as we, Transition as xe } from "vue";
    ...
    return (F, q) => t(c) ? (a(), h("nav", Ge, [
      ...
      e.hasData ? (a(), h("div", {
        ...
        (a(), x(I(t(l) ? "a" : "div"), {
          ...
          onClick: q[0] || (q[0] = B((b) => e.onClick(t(l)), ["prevent"]))
        }, {
          default: C(() => [
            Qe,
        ...
        (a(), x(I(t(f) ? "a" : "div"), {
          ...
          onClick: q[1] || (q[1] = B((b) => e.onClick(t(f)), ["prevent"]))
        }, {
          default: C(() => [
        ...
        s("div", null, [
          s("nav", nt, [
            (a(), x(I(t(l) ? "a" : "div"), {
              ...
              onClick: q[2] || (q[2] = B((b) => e.onClick(t(l)), ["prevent"]))
            }, {
              default: C(() => [
            ...
            (a(!0), h(P, null, O(t(r).links, (b, j) => (a(), h("div", { key: j }, [
              w(F.$slots, "link", {}, () => [
                !isNaN(b.label) || b.label === "..." ? (a(), x(I(b.url ? "a" : "div"), {
                  key: 0,
                  href: b.url,
                  ...
                  onClick: B((W) => e.onClick(b.url), ["prevent"])
                }, {
                  default: C(() => [
                    M(p(b.label), 1)
                  ]),
            ...
            (a(), x(I(t(f) ? "a" : "div"), {
              ...
              onClick: q[3] || (q[3] = B((b) => e.onClick(t(f)), ["prevent"]))
            }, {
              default: C(() => [
  ...
  setup(e) {
    ...
    const he = _(() => {
      ...
      return T(["filter", "columns", "cursor", "sort"], (y) => {
        const L = n[g + y];
        y === "sort" && L === r.value.defaultSort || L !== void 0 && (v = !0);
      }), v;
    });
    function Z() {
    ...
    function pe() {
      ...
      const v = l.value.cursor, y = l.value.page, L = l.value.sort, ue = l.value.perPage;
      return v && (g.cursor = v), y > 1 && (g.page = y), ue > 1 && (g.perPage = ue), L && (g.sort = L), g;
    }
    function ve() {
      const n = K.parse(location.search.substring(1)), d = o.name === "default" ? "" : o.name + "_";
      T(["filter", "columns", "cursor", "sort"], (v) => {
        delete n[d + v];
      }), delete n[f.value], T(pe(), (v, y) => {
        y === "page" ? n[f.value] = v : y === "perPage" ? n.perPage = v : n[d + y] = v;
      });
      let g = K.stringify(n, {
        filter(v, y) {
    ...
    return (n, d) => (a(), x(xe, null, {
      default: C(() => [
        (a(), h("fieldset", {
          ...
          w(n.$slots, "tableWrapper", { meta: t(j) }, () => [
            z(lr, {
              class: $({ "mt-3": !t(q) })
            }, {
              default: C(() => [
                w(n.$slots, "table", {}, () => [
                  s("table", ir, [
                    ...
                    s("tbody", hr, [
                      w(n.$slots, "body", { show: G }, () => [
                        (a(!0), h(P, null, O(t(b), (g, v) => (a(), h("tr", {
                          ...
                          (a(!0), h(P, null, O(t(r).columns, (y) => D((a(), h("td", {
                            key: `table-${e.name}-row-${v}-column-${y.key}`,
                            class: "text-sm py-4 px-6 text-gray-500 whitespace-nowrap"
                          }, [
                            w(n.$slots, `cell(${y.key})`, { item: g }, () => [
                              M(p(g[y.key]), 1)
                            ])
                          ])), [
                            [R, G(y.key)]
